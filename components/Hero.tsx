...
const SOCIALS = [
  {
    icon: GithubIcon,
    href: "https://github.com/alihaider5574",
    label: "GitHub",
  },
  {
    icon: LinkedinIcon,
    href: "https://www.linkedin.com/in/ali-haider-48918231b?utm_source=share_via&utm_content=profile&utm_medium=member_android",
    label: "LinkedIn",
  },
  {
    icon: Mail,
    href: "mailto:haider3056216@gmail.com",
    label: "Email",
  },
];
...
export default function Hero({ 
  ...
  const profileImage = settings?.profileImageUrl || "/ali_dark_bg.png";
      ...
      <div className="relative mx-auto max-w-[1280px] px-6 lg:px-8 w-full py-12 lg:py-0">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div className="space-y-8">
            ...
            >
              {settings?.heroSubtext || "Full-Stack Developer specializing in responsive design, robust APIs, and deploying end-to-end web solutions using modern frameworks like the MERN Stack."}
            </motion.p>
            ...
            >
              ...
              <MagneticButton strength={8}>
                <a
                  href={settings?.cvUrl || "/ALI_HAIDER_Resume.docx"}
                  target="_blank"
          ...
          >
            <div className="relative w-[300px] h-[300px] sm:w-[380px] sm:h-[380px] lg:w-[440px] lg:h-[440px]">
              ...
              <div className="hero-glow relative z-10 w-full h-[380px] sm:h-[460px] lg:h-[540px] rounded-[32px] overflow-hidden shadow-2xl">
                <Image
                  src={profileImage}
                  alt="Ali Haider"
                  fill
